package co.yixiang.web.controller.redis;
...
//    }
     ...
     *
     */
    @Bean(name = "redisMessageUtil")
    public RedisMessageUtil redisUtil(@Qualifier("redisTemplate") RedisTemplate<String, Object> redisTemplate) {
        RedisMessageUtil redisUtil = new RedisMessageUtil();
