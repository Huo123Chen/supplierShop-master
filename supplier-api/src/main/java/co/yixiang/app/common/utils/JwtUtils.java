...
public class JwtUtils {
    ...
    private static int ADVANCE_EXPIRE_TIME = 5*60*1000;

    private String signKey = "1234abcDG";

    private RedisTemplate<String, Object> redisTemplate;

    //设置 新token 过期时间
   private int JWT_EXPIRE_TIME_LONG = 5*60*1000;

    //设置 老token 过期时间
    private int OLD_TOKEN_EXPIRE_TIME = 5*60*1000;
   //版本号
    private String  jwtVersion = "1.0.0";
    ...
    public String getGoodToken(String userId){
        ...
        String token = (String) redisTemplate.opsForValue().get("userJwtToken_"+userId);
